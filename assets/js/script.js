...
//params for emailjs
const publicKey = "boG970OZPrm57zV-d";
const serviceID = "service_3s6c3th";
const templateID = "template_hhj3a9u";
...
form.addEventListener("submit", e => {
  ...
  .then(() => {
    ...
    notificationInput.textContent = "Message Sent Successfully";
    nameInput.value = "";
    emailInput.value = "";
    messageInput.value = "";
...
{
  var params = {
    from_name : document.getElementsByName("fullname").value,
    email_id : document.getElementsByName("email").value,
    message : document.getElementsByName("message").value
  }
  emailjs.send("service_3s6c3th", "template_hhj3a9u", params).then(function(res){
